...
# Overly optimistic (assumes perfect on-chip reuse of every operand).
...
def _parse_args(argv: list[str] | None = None):
    ...
    parser = argparse.ArgumentParser(
        description="MoE decode-FFN die-area / latency estimator "
        "(Snowcat traffic frontier + num_stages latency hiding)."
    )
    parser.add_argument(
        "--no-snowcat",
        action="store_true",
